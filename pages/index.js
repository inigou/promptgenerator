...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .demo-prog-bar { height: 100%; width: 33%; background: var(--indigo); border-radius: 5px; transition: width .3s; }
  ...
  .price-plan { font-size: .78rem; font-weight: 800; letter-spacing: .08em; text-transform: uppercase; margin-bottom: .75rem; }
  ...
  .price-btn { width: 100%; padding: 14px; border-radius: 100px; font-family: 'Nunito', sans-serif; font-size: .97rem; font-weight: 800; cursor: pointer; transition: all .2s; border: none; }
  ...
  @media (max-width: 768px) { .ba-grid { grid-template-columns: 1fr; } .longform-grid { grid-template-columns: 1fr; gap: 2rem; } .nav-link { display: none; } }
  ...
  return (
    <>
      <Head>
        ...
        <meta name="google-site-verification" content="e18aa69de57bb992" />
